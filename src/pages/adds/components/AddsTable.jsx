...
const AddsTable = ({
  ...
  const [selectedAd, setSelectedAd] = useState(null); // modal uchun tanlangan ad
            ...
            items.map((ad, idx) => (
              ...
              >
                ...
                <td className="px-2 py-2 flex gap-3 justify-center relative">
                  ...
                  {/* Dropdown */}
                  {openDropdown === ad.id && (
                    <div className="absolute right-0 top-8 bg-white shadow-lg rounded-md border border-gray-200 z-20 w-32">
                      <button
                        onClick={() => {
                          setSelectedAd(ad);
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-2 hover:bg-gray-100 text-sm text-red-600 flex items-center gap-1"
                      >
      ...
      {selectedAd && (
        ...
        >
          <div
            ...
            onClick={(e) => e.stopPropagation()} // tashqi bosilganda yopilsin
          >
