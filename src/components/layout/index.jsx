    ...
    <>
      ...
      <main className="flex h-[calc(100vh-60px)]">
        ...
        >
          ...
          <button
            onClick={toggleAside}
            className={`absolute outline-none cursor-pointer -top-3 -right-3 z-10 p-1 border-2 border-gray-300 bg-white hover:bg-blue-100 rounded-md transition-all duration-300`}
          >
